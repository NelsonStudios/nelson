...
return [
    'modules' => [
        ...
        'Mageplaza_Core' => 1,
        'Core_Serialize' => 1,
        'DevPhase_CategoryFeaturedWidget' => 1,
        'DevPhase_CategoryMenuBlocksWidget' => 1,
        ...
        'Magefan_Community' => 1,
        'Magefan_Blog' => 1,
        'Core_MageplazaSlider' => 1,
        'Fecon_BannerSlider' => 1,
