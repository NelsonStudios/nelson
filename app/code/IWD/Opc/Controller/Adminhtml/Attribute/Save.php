 ...
 */
class Save extends \IWD\Opc\Controller\Adminhtml\Customer\Attribute
{
    /**
     ...
     * @param \Magento\Customer\Model\Attribute $opc
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if ($attributeId) {
                ...
                $data['source_model'] = $this->opcHelper->getAttributeSourceModelByInputType(
                    $data['frontend_input']
                );
                $data['backend_model'] = $this->opcHelper->getAttributeBackendModelByInputType(
                    $data['frontend_input']
                );
            }
