<?php
namespace DevPhase\CategoryFeaturedWidget\Block\Widget;

class CategoryFeaturedWidget extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    protected $_template = 'widget/categoryfeaturedwidget.phtml';
