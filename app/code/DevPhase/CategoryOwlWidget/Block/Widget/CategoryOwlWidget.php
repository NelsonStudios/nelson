<?php
namespace DevPhase\CategoryOwlWidget\Block\Widget;

class CategoryOwlWidget extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    protected $_template = 'widget/categoryowlwidget.phtml';
