...
class VolumePacker implements LoggerAwareInterface
{
     ...
     */
    public function setLookAheadMode(bool $lookAhead)
    {
    ...
    /**
     * @param ItemInterface            $itemToPack
     ...
     * @return bool
     */
    protected function checkNonDimensionalConstraints(ItemInterface $itemToPack)
    {
