...
namespace Core\GeoIP\Controller\Adminhtml\Database;
...
class Update extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $helperDatabase =  $this->_objectManager->get(
            \MageWorx\GeoIP\Helper\Database::class
        );
        /** @var \MageWorx\GeoIP\Model\Geoip $geoip */
        $geoip = $this->_objectManager->get(\MageWorx\GeoIP\Model\Geoip::class);
        /** @var \Magento\Config\Model\ResourceModel\Config $config */
        $config = $this->_objectManager->get(
