...
class Geoip extends \Magento\Framework\Model\AbstractModel
{
    ...
    protected function getGeoIpLocation($ip)
    {
        ...
        $helperDatabase = $this->objectManager->get(
            \MageWorx\GeoIP\Helper\Database::class
        );
    ...
    {
        $helperCountry = $this->objectManager->get(
            \MageWorx\GeoIP\Helper\Country::class
        );
    ...
    public function getCurrentLocation()
    {
        ...
        if (!$session->getCustomerLocation() || !$session->getCustomerLocation()->getCode()) {
            $ip = $this->objectManager->get(
                \MageWorx\GeoIP\Helper\Customer::class
            )->getCustomerIp();
