 ...
 */
namespace Core\ShippingRules\Setup;
...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function __construct(
        ...
        if ($this->isUsedJsonSerializedValues()) {
            $this->aggregatedFieldConverter = $objectManager->get(
                \Magento\Framework\DB\AggregatedFieldDataConverter::class);
            $this->jsonSerializer = $objectManager->get(
    ...
    public function isUsedJsonSerializedValues()
    {
        ...
        if (version_compare($version, '2.2.0', '>=') &&
            class_exists(\Magento\Framework\DB\AggregatedFieldDataConverter::class)
        ) {
            return true;
        }
