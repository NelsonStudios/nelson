...
namespace Fecon\BannerSlider\Model\Config\Source;

use Magento\Framework\Option\ArrayInterface;

/**
 * Class Location
 * @package Fecon\BannerSlider\Model\Config\Source
 */
class Location extends \Mageplaza\BannerSlider\Model\Config\Source\Location implements ArrayInterface
{
    ...
    const CATALOGSEARCH_RESULT_PAGE_TOP = 'catalogsearch_result_index.page-top';
        ...
        $options = [
            ...
            [
                ...
                'value' => [
                    [
                        'label' => __('Top of page'),
                        'value' => self::CATALOGSEARCH_RESULT_PAGE_TOP
                    ]
                ]
            ],
            [
