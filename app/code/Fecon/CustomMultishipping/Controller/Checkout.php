 ...
 */
namespace Fecon\CustomMultishipping\Controller;
    ...
    \Magento\Checkout\Controller\Express\RedirectLoginInterface
{
    ...
    {
        return $this->_objectManager->get(\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping::class);
    }

    /**
     * Retrieve checkout state model
     *
     * @return \Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping\State
     */
    protected function _getState()
    {
        return $this->_objectManager->get(\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping\State::class);
    }

    /**
     * Retrieve checkout url helper
     *
     * @return \Fecon\CustomMultishipping\Helper\Url
     */
    protected function _getHelper()
    {
        return $this->_objectManager->get(\Fecon\CustomMultishipping\Helper\Url::class);
    }
    ...
    public function dispatch(RequestInterface $request)
    {
        ...
        if (!in_array($action, ['login', 'register'])) {
            ...
            if (!$this->_objectManager->get(
                \Fecon\CustomMultishipping\Helper\Data::class
