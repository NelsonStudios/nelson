...
{
    /**
     * @var \Fecon\CustomMultishipping\Controller\Checkout\Address\NewShipping
     */
    ...
    protected function setUp()
    {
        ...
        $this->controller = $objectManager->getObject(
            \Fecon\CustomMultishipping\Controller\Checkout\Address\NewShipping::class,
            ['context' => $contextMock]);
    }
    ...
    public function testExecute($backUrl, $shippingAddress, $url)
    {
        $this->stateMock
            ...
            ->with(\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping\State::STEP_SELECT_ADDRESSES);
