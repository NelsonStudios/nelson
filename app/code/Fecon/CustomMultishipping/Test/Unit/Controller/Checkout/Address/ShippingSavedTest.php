...
use Fecon\CustomMultishipping\Controller\Checkout\Address\ShippingSaved;
...
class ShippingSavedTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->checkoutMock = $this->createMock(\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping::class);
        $this->objectManagerMock = $this->createMock(\Magento\Framework\ObjectManagerInterface::class);
        $this->objectManagerMock->expects($this->any())
            ->method('get')
            ->with(\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping::class)
        ...
        $this->controller = new \Fecon\CustomMultishipping\Controller\Checkout\Address\ShippingSaved(
            $this->contextMock,
