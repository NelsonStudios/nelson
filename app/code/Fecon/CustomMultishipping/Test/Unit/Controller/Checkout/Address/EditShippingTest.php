...
namespace Fecon\CustomMultishipping\Test\Unit\Controller\Checkout\Address;
 ...
 */
class EditShippingTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \Fecon\CustomMultishipping\Controller\Checkout\Address\EditShipping
     */
    ...
    protected function setUp()
    {
        ...
        $valueMap = [
            [\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping\State::class, $this->stateMock],
            [\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping::class, $this->checkoutMock]
        ];
        ...
        $this->controller = $objectManager->getObject(
            \Fecon\CustomMultishipping\Controller\Checkout\Address\EditShipping::class,
            ['context' => $contextMock]);
    }
    ...
    public function testExecute()
    {
        $this->stateMock
            ...
            ->with(\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping\State::STEP_SHIPPING);
        ...
        $this->addressFormMock
            ...
            ->willReturnSelf();
        $helperMock = $this->createPartialMock(\Fecon\CustomMultishipping\Helper\Data::class, ['__']);
