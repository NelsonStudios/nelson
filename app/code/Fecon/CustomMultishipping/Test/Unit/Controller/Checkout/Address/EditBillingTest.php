...
{
    /**
     * @var \Fecon\CustomMultishipping\Controller\Checkout\Address\EditBilling
     */
    ...
    protected function setUp()
    {
        ...
        $this->controller = $objectManager->getObject(
            \Fecon\CustomMultishipping\Controller\Checkout\Address\EditBilling::class,
            ['context' => $contextMock]);
    }
    ...
    public function testExecute()
    {
        $this->stateMock
            ...
            ->with(\Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping\State::STEP_BILLING);
