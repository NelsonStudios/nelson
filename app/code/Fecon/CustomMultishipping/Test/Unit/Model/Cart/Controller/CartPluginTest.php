 ...
 */
namespace Fecon\CustomMultishipping\Test\Unit\Model\Cart\Controller;

class CartPluginTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \Fecon\CustomMultishipping\Model\Cart\Controller\CartPlugin
     */
    private $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = new \Fecon\CustomMultishipping\Model\Cart\Controller\CartPlugin(
