 ...
 */
namespace Fecon\CustomMultishipping\Test\Unit\Model\Payment\Method\Specification;
...
class EnabledTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testIsSatisfiedBy($methodsInfo, $result)
    {
        ...
        $configSpecification = $this->objectManager->getObject(
            \Fecon\CustomMultishipping\Model\Payment\Method\Specification\Enabled::class,
