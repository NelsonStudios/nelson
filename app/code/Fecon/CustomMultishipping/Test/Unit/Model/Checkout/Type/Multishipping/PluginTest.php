...
class PluginTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping\Plugin
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = new \Fecon\CustomMultishipping\Model\Checkout\Type\Multishipping\Plugin($this->checkoutSessionMock);
    }
