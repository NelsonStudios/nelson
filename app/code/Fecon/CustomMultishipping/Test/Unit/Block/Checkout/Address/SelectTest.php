...
namespace Fecon\CustomMultishipping\Test\Unit\Block\Checkout\Address;
...
{
    /**
     * @var \Fecon\CustomMultishipping\Block\Checkout\Address\Select
     */
    protected $block;
    ...
    protected function setUp()
    {
        ...
        $this->block = $this->objectManager->getObject(
            \Fecon\CustomMultishipping\Block\Checkout\Address\Select::class, [
