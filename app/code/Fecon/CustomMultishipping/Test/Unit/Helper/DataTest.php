 ...
 */
namespace Fecon\CustomMultishipping\Test\Unit\Helper;
...
class DataTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $arguments = $objectManager->getConstructArguments(\Fecon\CustomMultishipping\Helper\Data::class);
        $this->helper = $objectManager->getObject(\Fecon\CustomMultishipping\Helper\Data::class, $arguments);
    ...
    public function testGetMaximumQty()
    {
        ...
        $this->scopeConfigMock->expects(
            ...
            \Fecon\CustomMultishipping\Helper\Data::XML_PATH_CHECKOUT_MULTIPLE_MAXIMUM_QUANTITY
        )->will(
    ...
    public function testIsMultishippingCheckoutAvailable(
        ...
        $this->scopeConfigMock->expects(
            ...
            \Fecon\CustomMultishipping\Helper\Data::XML_PATH_CHECKOUT_MULTIPLE_AVAILABLE
        )->will(
