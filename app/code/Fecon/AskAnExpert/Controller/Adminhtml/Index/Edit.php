...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('askanexpert', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('AskAnExpert'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? __('Reply  ', $model->getTitle()) : __('Submission'));
