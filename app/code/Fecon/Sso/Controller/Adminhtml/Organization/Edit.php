...
class Edit extends \Fecon\Sso\Controller\Adminhtml\Organization
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('fecon_sso_organization', $model);
        
        // 3. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Organization') : __('New Organization'),
            $id ? __('Edit Organization') : __('New Organization')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Organizations'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Organization %1', $model->getId()) : __('New Organization'));
        return $resultPage;
    }
}
