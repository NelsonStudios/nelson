...
$metadata['https://172.21.0.10/simplesaml/module.php/saml/sp/metadata.php/default-sp'] = array (
  'SingleLogoutService' => 
  array (
    0 => 
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
      'Location' => 'https://172.21.0.10/simplesaml/module.php/saml/sp/saml2-logout.php/default-sp',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'Location' => 'https://172.21.0.10/simplesaml/module.php/saml/sp/saml2-acs.php/default-sp',
    ),
    1 => 
    array (
      'index' => 1,
      'Binding' => 'urn:oasis:names:tc:SAML:1.0:profiles:browser-post',
      'Location' => 'https://172.21.0.10/simplesaml/module.php/saml/sp/saml1-acs.php/default-sp',
    ),
    2 => 
    array (
      'index' => 2,
    ...
    array (
      ...
      'Location' => 'https://172.21.0.10/simplesaml/module.php/saml/sp/saml1-acs.php/default-sp/artifact',
    ),
  ),
);
